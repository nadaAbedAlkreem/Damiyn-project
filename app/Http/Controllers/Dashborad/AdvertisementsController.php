...
class AdvertisementsController extends Controller
{
    ...
    {  
     if ($request->ajax()) {
         ...
         return Datatables::of($data)
                 ...
                 {
                   return '
                   <button type="button"  class="btn btn-xs btn-primary"      data-id="'.$data->id.'"         
          ...
          return view('dashborad.advertisement.view') ; 
      }
 ...
 public function store(AdvertisementRequest $request)
 {
  ...
  $advertisement->image =$name_image ;
 ...
 {
  $result =  Advertisement::find($id)->delete($id);
