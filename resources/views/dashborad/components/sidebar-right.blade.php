												...
												<div class="tab-content">
													<div class="tab-pane tab-content-show active" id="side32">
														<ul class="sidemenu-list">
															...
															<li><a class="slide-item" href="{{route('partners.view')}}">partners</a></li>
															<li><a class="slide-item" href="{{route('services.view')}}">services</a></li>
															<li><a  class="slide-item" href="{{route('blogs.view')}}">Blog-Edit</a></li>
															<li><a  class="slide-item" href="{{route('advertisement.view')}}">advertisement</a></li>
															<li><a  class="slide-item" href="{{route('rating.view')}}">rating</a></li>
															<li><a  class="slide-item" href="{{route('setting.view')}}"> setting   </a></li>
															<li><a  class="slide-item" href="{{route('order.view')}}">orders</a></li>
