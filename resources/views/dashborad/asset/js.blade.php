		...
		<script src="{{url('assets/js/modal-popup.js')}}"></script>
  	...
  	<script src="{{url('assets/plugins/fileuploads/js/fileupload.js')}}"></script>
        ...
        <script src="{{url('assets/plugins/fancyuploder/fancy-uploader.js')}}"></script><script src="assets/plugins/jquery/jquery.min.js"></script>
	...
	<script src="{{url('https://maps.googleapis.com/maps/api/js?key=AIzaSyCcABaamniA6OL5YvYSpB3pFMNrXwXnLwU')}}" defer></script>
